...
def apply_homography_list(H: np.ndarray, points):
    """
...
def get_new_corners(image: np.ndarray, H: np.ndarray) :
    """
...
def get_offset(corners) -> np.ndarray:
    """
...
def single_weights_matrix(shape) -> np.ndarray:
    """
